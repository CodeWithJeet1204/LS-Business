...
import 'package:localy/vendors/page/main/profile/data/all_discounts_page.dart';
                                                                ...
                                                                Navigator.of(
                                                                  ...
                                                                  MaterialPageRoute(
                                                                    builder:
                                                                        ((context) =>
                                                                            CategoryPage(
                                                                              categoryName: categoryData['specialCategoryName'],
                                                                            )),
                                                                  ),
                                                                );
                                                              },
                                                                        ...
                                                                        IconButton(
                                                                          onPressed:
                                                                            ...
                                                                            await removeProductBrandCategory(
                                                                              widget.discountId,
                                                                              'Special Category',
                                                                              categoryData['specialCategoryId'],
                                                                            );
                                                                          },
                                                                          icon:
                                                                              Icon(
