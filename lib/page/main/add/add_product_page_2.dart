                          ...
                          ? TextFormField(
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  ...
                                  return 'Enter ${getPropertiesKeys(0)}';
                                }
                              },
                            )
                          : getNoOfAnswers(0) == 2
                          ...
                          ? TextFormField(
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  ...
                                  return 'Enter ${getPropertiesKeys(1)}';
                                }
                              },
                            )
                          : getNoOfAnswers(1) == 2
                          ...
                          ? TextFormField(
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  ...
                                  return 'Enter ${getPropertiesKeys(2)}';
                                }
                              },
                            )
                          : getNoOfAnswers(2) == 2
                          ...
                          ? TextFormField(
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  ...
                                  return 'Enter ${getPropertiesKeys(3)}';
                                }
                              },
                            )
                          : getNoOfAnswers(3) == 2
                          ...
                          ? TextFormField(
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  ...
                                  return 'Enter ${getPropertiesKeys(4)}';
                                }
                              },
                            )
                          : getNoOfAnswers(4) == 2
                          ...
                          ? TextFormField(
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  ...
                                  return 'Enter ${getPropertiesKeys(5)}';
                                }
                              },
                            )
                          : getNoOfAnswers(5) == 2
                      ...
                      child: InfoBox(
                        ...
                        widget1: Column(
                          ...
                          children: [
                            ...
                            otherInfoController.text.toString().length > 1
                                ? Row(
                                    crossAxisAlignment:
                                    ...
                                    children: [
                                      Expanded(
                                        child: TextFormField(
                                          controller: otherInfoValueController,
                                          maxLines: 1,
                                          minLines: 1,
                                          keyboardType: TextInputType.text,
                                          decoration: const InputDecoration(
